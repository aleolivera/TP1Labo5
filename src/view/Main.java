	...
	public static void main(String[] args) {
		...
		else
		{
			EventoTeatro eventoTeatro = new EventoTeatro(
						actores, new Genero ("Dramaturgo"),"Fausto", 
						Duration.ofMinutes(50), LocalDate.of(2022, 4, 6)
					);
		...
		{
			EventoTeatro eventoTeatro2 = new EventoTeatro(
						actores2, new Genero ("Comedia"),"mucho ruido pocas nueces", 
						Duration.ofMinutes(50), LocalDate.of(2022, 10, 6)
					);
		...
		EventoRecital eventoRecital = new EventoRecital(
					"Cosquín Rock",Duration.ofMinutes(120),LocalDate.of(2022, 10, 10), 
					new Banda("los Beatles",new Genero("rock")),bandaSopote
				);
		...
		EventoRecital eventoRecital2 = new EventoRecital(
					"pop",Duration.ofMinutes(120), LocalDate.of(2022, 7, 7),
					new Banda("coldplay",new Genero("pop")),bandaSopote2
					);
